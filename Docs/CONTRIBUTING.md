...
The CoordinatorKit maintainers takes security seriously.
...
See [CODE_OF_CONDUCT.md](https://github.com/bfernandesbfs/CoordinatorKit/blob/master/CODE_OF_CONDUCT.md) for details.
